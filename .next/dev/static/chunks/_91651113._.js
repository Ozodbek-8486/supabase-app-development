...
function ChatPage() {
    ...
    const [keyInputValue, setKeyInputValue] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])("");
    ...
    const [savedAdminPassword, setSavedAdminPassword] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])("Ozodbek-2008");
    const [onlineCount, setOnlineCount] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(1);
    ...
    const toastTimeoutRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])();
    // Supabase client
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "ChatPage.useEffect": ()=>{
            const savedKey = localStorage.getItem("supabase_anon_key");
            if (savedKey) {
                setSupabase((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$supabase$2f$ssr$2f$dist$2f$module$2f$createBrowserClient$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createBrowserClient"])(SUPABASE_URL, savedKey));
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "ChatPage.useEffect": ()=>{
            ...
            const channel = supabase.channel("chat-realtime").on("postgres_changes", {
                ...
                "ChatPage.useEffect.channel": (payload)=>{
                    const newMsg = payload.new;
                    setMessages({
                        "ChatPage.useEffect.channel": (prev)=>{
                            if (prev.find({
                                "ChatPage.useEffect.channel": (m)=>m.id === newMsg.id
                            }["ChatPage.useEffect.channel"])) return prev;
                            return [
                                ...prev,
                                newMsg
                            ];
                        }
                    }["ChatPage.useEffect.channel"]);
                }
            }["ChatPage.useEffect.channel"]).on("postgres_changes", {
                event: "UPDATE",
                schema: "public",
                table: "chat_messages"
            }, {
                "ChatPage.useEffect.channel": (payload)=>{
                    ...
                    setMessages({
                        "ChatPage.useEffect.channel": (prev)=>prev.map({
                                "ChatPage.useEffect.channel": (m)=>m.id === updated.id ? updated : m
                            }["ChatPage.useEffect.channel"])
                    }["ChatPage.useEffect.channel"]);
                }
            }["ChatPage.useEffect.channel"]).on("postgres_changes", {
                ...
                "ChatPage.useEffect.channel": (payload)=>{
                    ...
                    setMessages({
                        "ChatPage.useEffect.channel": (prev)=>prev.filter({
                                "ChatPage.useEffect.channel": (m)=>m.id !== deleted.id
                            }["ChatPage.useEffect.channel"])
                    }["ChatPage.useEffect.channel"]);
                }
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "ChatPage.useEffect": ()=>{
            ...
            const uniqueUsers = new Set(messages.map({
                "ChatPage.useEffect": (msg)=>msg.username
            }["ChatPage.useEffect"]));
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("form", {
                        onSubmit: (e)=>{
                            ...
                            if (keyInputValue) {
                                ...
                                setSupabase((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$supabase$2f$ssr$2f$dist$2f$module$2f$createBrowserClient$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createBrowserClient"])(SUPABASE_URL, keyInputValue));
                                setShowKeyInput(false);
                            }
                        },
                        children: [
                            ...
                            children: [
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    ...
                                    children: [
                                        ...
                                        showAdminMenu && isAdmin && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
...
_s(ChatPage, "6bsK68lpm/zyW5gE86M9/jQsozE=");
_c = ChatPage;
var _c;
...
//# sourceMappingURL=_91651113._.js.map